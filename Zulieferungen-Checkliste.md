...
| 3.10 | **Calendly-Terminbuchung:** Die Buchungsseite auf `/kontakt.html` zeigt auf das **private Konto `luka-bloemendal`**. Bitte ein LIBA-Calendly-Konto anlegen (oder die Terminbuchung streichen) und mir die URL nennen. | Vor Go-Live zwingend — sonst buchen Kunden Termine bei der falschen Person. | Calendly-Konto der Firma. |
